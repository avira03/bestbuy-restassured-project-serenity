...
public class StoreCrudWithSteps extends TestBase {
    static String name = TestUtils.getRandomValue() + "James";
    static String type = TestUtils.getRandomValue() + "BigBox";
    static String address = TestUtils.getRandomValue() + "MalletDrive";
    static String address2 = TestUtils.getRandomValue() + "Harrow";
    static String city = TestUtils.getRandomValue() + "London";
    static String state = TestUtils.getRandomValue() + "UK";
    static String zip = TestUtils.getRandomValue() + "566324";
